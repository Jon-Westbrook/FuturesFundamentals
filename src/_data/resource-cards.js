module.exports = {
  ...
  'lesson.choice': {
    ...
    copy: 'Explore how individual decision-making can be influenced by peers, businesses, organizations, and others.',
    link: 'https://www.econessentialsinschool.com/behavioral-econ-lessons#lesson-three',
  ...
  'lesson.intro': {
    ...
    copy: 'Explore behavioral economic theory and the mysteries behind human decision-making.',
    link: 'https://www.econessentialsinschool.com/behavioral-econ-lessons#introduction',
  ...
  'lesson.price': {
    ...
    copy: 'Are people’s buying decisions dictated more by preference or by price? Learn how concepts like price anchoring can play a role.',
    icon: 'link-external',
  ...
  'pdf.speculator': {
    ...
    copy: 'Speculator activity often comes under scrutiny when the markets fluctuate.',
    icon: 'download',
  ...
  'video.cuba': {
    ...
    copy: 'Meet a restaurateur looking to capitalize on new opportunities and build her business. Continue learning with the three-part series by Seeker Stories.',
    link: 'http://www.econessentialsinschool.com/videos',
